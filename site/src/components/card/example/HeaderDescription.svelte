<script>
  ...
  const demoCode = codeTemplate.headerDescription;
...
<div class="tdesign-demo-wrapper tdesign-demo-item--card-header-description tdesign-demo-item--card">
  <td-doc-demo mode="auto" language="markup" code={demoCode}>
    <div class="tdesign-demo-item__body">
      <TCard {title} {description} style="width: 400px">
        {infoMessage}
