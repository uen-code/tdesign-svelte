<script>
  ...
  const demoCode = codeTemplate.bordered;
...
<div class="tdesign-demo-wrapper tdesign-demo-item--card-header-bordered tdesign-demo-item--card">
  <td-doc-demo mode="auto" language="markup" code={demoCode}>
    <div class="tdesign-demo-item__body">
      <div>
        <TCard {title} style="width: 400px" headerBordered>
          {infoMessage}
