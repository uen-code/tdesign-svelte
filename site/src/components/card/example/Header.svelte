<script>
  ...
  const demoCode = codeTemplate.header;
...
<div class="tdesign-demo-wrapper tdesign-demo-item--card-header tdesign-demo-item--card">
  <td-doc-demo mode="auto" language="markup" code={demoCode}>
    <div class="tdesign-demo-item__body">
      <div>
        <TCard hoverShadow {title} style="width: 400px">
          {infoMessage}
